# Podium Pulse — неофициальный гоночный companion (Telegram Mini App)

Глобальный mobile-first редизайн существующего Race Hub с сохранением Telegram auth,
Cloudflare backend, уведомлений и реального data layer.
...
- [x] Реальные данные в `Home`, `Calendar`, `Championship` и detail-экранах
